...
export async function loadServiceCustomColumnOptions(
	...
	try {
		type ConfigResponse =
			paths['/v1/services/configuration']['get']['responses']['200']['content']['application/json'];
		const response = (await this.helpers.httpRequest({
			method: 'GET',
			url: `${getBaseURL(credentials)}/api/v1/services/configuration`,
			headers: {
